<template>
    <div class="panel panel-primary" v-cloak>
        ...
        <div class="panel-body">
                ...
                >
                    <div class="pull-right">
                        <button
                            ...
                            v-on:click="editExperience(experience)"
                        >
                            Edit
                        </button>
                        <button
                            class="btn btn-danger btn-sm"
                            v-on:click="deleteExperience(experience)"
                        >
                            Delete
                        </button>
                    </div>
            ...
            <div v-if="experiences.length == 0">No Experiences to Display.</div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        getExperience: function () {
            axios
                .get(window.Laravel.url + "/api/getexperiences2")
                .then((response) => {
        ...
        addExperience: function () {
            axios
                .post(window.Laravel.url + "/api/addexperiences", this.experience)
                .then((response) => {
        ...
        updateExperience: function () {
            axios
                .put(window.Laravel.url + "/api/updateexperiences", this.experience)
                .then((response) => {
                    // this.experience = response.data;
