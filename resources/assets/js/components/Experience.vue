				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-2 text-right">
							<button class="btn btn-success" v-on:click="openExperience =true; editExperienceToggle=false">Ajouter</button>
						</div>
					</div>
				...
				<div class="panel-body">
					<div v-if="openExperience">
						...
						<div class="row">
							...
							<button class="btn btn-success btn-block" v-if="!editExperienceToggle" v-on:click="addExperience">Ajouter</button>
